...
'drilldown', 1, 'sales',
'["销售额", "亚马逊销售额", "总订单数", "订单量", "B2B订单量", "总销量", "退款量", "国内收入", "跨境收入", "销售额_mom_rate", "订单量_mom_rate", "销售额_yoy_rate", "订单量_yoy_rate"]'::jsonb,
'drilldown', 1, 'Base Metrics'
);

-- Ad (Chinese column aliases)
INSERT INTO sql_templates (name, description, sql_template, intent, status, drilldown_category, metric_names, template_type, template_order, template_name)
VALUES (
  'Ad-Drilldown',
...
FROM base_data b, mom m, yoy y',
'drilldown', 1, 'ad',
'["广告花费", "广告展示数", "广告点击数", "广告订单数", "广告销售额", "总会话数", "总页面浏览量", "广告花费_mom_rate", "广告销售额_mom_rate", "广告花费_yoy_rate", "广告销售额_yoy_rate"]'::jsonb,
'drilldown', 1, 'Base Metrics'
);

-- Cost (Chinese column aliases)
INSERT INTO sql_templates (name, description, sql_template, intent, status, drilldown_category, metric_names, template_type, template_order, template_name)
VALUES (
  'Cost-Drilldown',
...
FROM base_data b, mom m, yoy y',
'drilldown', 1, 'cost',
'["销售额", "成本", "税前利润", "平台贡献", "平台服务费", "促销费", "运费", "关税", "销售额_mom_rate", "利润_mom_rate", "销售额_yoy_rate", "利润_yoy_rate"]'::jsonb,
'drilldown', 1, 'Base Metrics'
);

-- Inventory (Chinese column aliases)
INSERT INTO sql_templates (name, description, sql_template, intent, status, drilldown_category, metric_names, template_type, template_order, template_name)
VALUES (
  'Inventory-Drilldown',
  'Inventory metrics',
...
'["库存数量", "在途库存", "仓库成本", "总销售额", "总成本", "销售量", "退货量", "销售量_mom_rate", "销售额_yoy_rate"]'::jsonb,
'drilldown', 1, 'Base Metrics'
);
